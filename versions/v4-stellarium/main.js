...
(function () {
  ...
  /* ---------- hero intro ---------- */
  var hero = document.querySelector('.hero, .page-hero, .stel-hero, .ast-hero');
  if (hero) {
  ...
  /* ---------- section reveals ---------- */
  gsap.utils.toArray('section:not(.hero):not(.page-hero):not(.stel-hero):not(.ast-hero), .detail, footer').forEach(function (s) {
